...
for(A in ages) {
  ...
  datos<-drates[drates$Year%in%c(1930:2004) & drates$Age==ages[A+1], ]
  datos$Female<-datos$Female*100#-datos$Female[1]
  datos$Male<-datos$Male#-datos$Male[1]
...
for(i in 1931:2004)
{  
  htWomen[i-1929,2]<-alphaMujPost$al1[alphaMujPost$age==age]*i +alphaMujPost$al2[alphaMujPost$age==age]*htWomen[i-1930,2]+alphaMujPost$al2[alphaMujPost$age==age]*htWomen[i-1929,2]#+DM[1,i-1929]
 # htMen[i-1929,2]<-hm0*exp(alphaHom[age+1]*i + DM[1,i-1929]
  htWomen[i-1929,1]<-i
  htMen[i-1929,1]<-i
>>>>>>> ae487bacaa6d21b6088d6638b760b1425aa33dbb
