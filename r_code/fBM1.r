...
#####  Estimation of the rates mortalities.####
  ...
  #### hacer la media muestral y varianza muestral para ht_hat, #### 
  #### primero modificar el codigo de 
  ...
  #lines(years[1:55],ht_hat_mean[1:55]+Desv_stan[1:55], type="l", col="brown")
  lines(years[1:55],ht_hat_mean[1:55]-1.96*Desv_stan[1:55], type="l",lty=4, col="brown")
  lines(years[1:55],ht_hat_mean[1:55]+1.96*Desv_stan[1:55], type="l",lty=4, col="brown")
  ...
  #lines(years[1:55],ht_hat_meanM[1:55]+Desv_stanM[1:55], type="l", col="brown")
  lines(years[1:55],ht_hat_meanM[1:55]-1.96*Desv_stanM[1:55], type="l",lty=4, col="brown")
  lines(years[1:55],ht_hat_meanM[1:55]+1.96*Desv_stanM[1:55], type="l",lty=4, col="brown")
  ...
  lines( years1[79:141],ht_hat_mean[1:63]-1.96*Desv_stan[1:63], type="l",lty=4, col="brown")
  lines( years1[79:141],ht_hat_mean[1:63]+1.96*Desv_stan[1:63], type="l",lty=4, col="brown")
  ablineclip(v=2004,y1=min(datos2F$Female[1:63]),
  ...
  #lines(years[1:54],ht_hat_meanM[1:54]+Desv_stanM[1:54], type="l", col="brown")
  lines( years1[79:141],ht_hat_meanM[1:63]-1.96*Desv_stanM[1:63], type="l",lty=4, col="brown")
  lines( years1[79:141],ht_hat_meanM[1:63]+1.96*Desv_stanM[1:63], type="l",lty=4, col="brown")
