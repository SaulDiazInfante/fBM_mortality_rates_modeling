...
\newcommandx{\change}[2][1=]{
        \todo[linecolor=blue,https://www.dropbox.com/business
...
\begin{figure}[H]
    \includegraphics[width = 4.5in,  height=4in]{Hurst-Women.eps}
    %\includegraphics[width = 2.6in]{Hurst-Men.eps}
...
\begin{figure}[H]
    \includegraphics[width = 4.5in, height=4in]{Hurst-Men.eps}
    \caption{\bf Estimated Hurst parameter using R-routines.}
