...
\begin{abstract}
    ...
    \paragraph{Background. Why I did carry out this project?}

            An accurate estimation of mortality rates is crucial to make
        decisions. For example the ensures companies, investment projects
        among others its operations according to estimations of this rates.
        The great number of variables and its complex relation implies a great
        challenge estimation.

            We assume the following hypothesis:
        The mortality rate has a strong relationship with its owns past. In
        this line, we propose a stochastic model with long-term memory that
        describes mortality. Then, using data from Italy, we provide
        statistical evidence via Hurst parameter estimation that do not reject
        our hypothesis. Further, we extract a subset data to evaluate its
        forecasting performance.

            What were my results
        What was new compared to previous research?
        Compared with the present literature, our model is the first
        attempt that considers long-term memory effects and shows good
        performance  respect to data fitting and forecasting.

            What are the implications of my findings? What are my %
        conclusions and / or recommendations?
        Our model can explain mortality rates of woman in Italy from
        year--- year. However, since man data usually has more dispersion,
        we observe that sex and age would be an important variable.
